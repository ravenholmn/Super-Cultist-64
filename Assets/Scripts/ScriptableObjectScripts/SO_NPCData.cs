...
public class SO_NPCData : ScriptableObject
{
    ...
    public float TextSpeed()
    {
        ...
        if (currentDialogue.lines[currentDialogue.lineIndex].textSpeed <= 0)
        {
            return currentDialogue.lines[currentDialogue.lineIndex].character == Character.Npc ? defaultTextSpeed : PlayerController.Instance.PlayerConfig.playerTextSpeed;
        }
        return currentDialogue.lines[currentDialogue.lineIndex].textSpeed;
    }
